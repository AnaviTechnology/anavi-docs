...
ANAVI I2C TPM 2.0 hardware design is licensed under a  Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0).
...
There is no warranty for the design materials and the components used to create ANAVI I2C TPM 2.0. They are considered suitable only for ANAVI I2C TPM 2.0.
...
[ANAVI I2C TPM 2.0](https://www.crowdsupply.com/anavi-technology/anavi-tpm-2-0-for-raspberry-pi) is a user-friendly add-on board for Raspberry Pi single board computers that interfaces via the I2C interface and is based on the Infineon Optiga SLB 9673 TPM 2.0 chip.
...
ANAVI I2C TPM 2.0 is a fully open-source project that combines open hardware with free and open-source software. It provides a reliable solution for secure key storage and cryptographic operations, and it can also function as a True Hardware Random Number Generator (TRNG), offering a high-entropy source suitable for security-critical applications. The printed circuit board was designed using [KiCAD](http://kicad.org/), an open-source electronics design suite. No soldering is required. You can assemble ANAVI I2C TPM 2.0 to your Raspberry Pi with your bare hands.

ANAVI I2C TPM 2.0 for Raspberry Pi is fully compatible with the Raspberry Pi OS.

## Features

**Trusted Platform Module**: Infineon Optiga SLB 9673 TPM 2.0
**Standards compliance**: Compliant with TCG TPM 2.0 Library Specification Rev. 1.59 and PC Client Platform TPM Profile (PTP) version 1.05
...
**Interface**: I2C
**Compact**: Only uses 5 header pins (1x5 pins: 1, 3, 5, 7 and 9), leaving other GPIO pins free
**Secure mounting**: Two small holes included for physical attachment
**Dimensions**: 16.5 x 12.8mm (0.65 x 0.51 inches)

## Supported Raspberry Pi Versions and Models

ANAVI I2C TPM 2.0 is compatible with the following Raspberry Pi versions and models:

* [Raspberry Pi 5](https://www.raspberrypi.com/products/raspberry-pi-5/)
* [Raspberry Pi 500](https://www.raspberrypi.com/products/raspberry-pi-5/)
...
Designed as open source hardware, ANAVI I2C TPM 2.0 is intended for developers, hobbyists, and professionals who require enhanced security for Raspberry Pi-based projects.

## Board Version

Revision 1.1 of ANAVI I2C TPM 2.0 was used while writing this document. It is possible that it is outdated so it is always recommended to check the latest sources from the GitHub page of the board.

# Getting Started

## Electrostatic Warning

ANAVI I2C TPM 2.0 is shipped in a protective antistatic bag. The add-on board as well as the Raspberry Pi must **NOT** be exposed to high electrostatic potentials. A grounding strap or similar protective device should be worn when handling the board. Avoid touching the component pins or any other metallic element.

## Requirements

In order to setup ANAVI I2C TPM 2.0 the following items are required:
...
You can assemble ANAVI I2C TPM 2.0 and mount it on your Raspberry Pi single board computer with your bare hands following the steps below:

* Power off your Raspberry Pi.
* Gently mount ANAVI I2C TPM 2.0 on the 40 pin header of your Raspberry Pi.

## Powering ANAVI I2C TPM 2.0

ANAVI I2C TPM 2.0 is a Raspberry Pi add-on board therefore it is powered through the Raspberry Pi single board computer. It is recommended to use the [official Raspberry Pi Power Supply](https://www.raspberrypi.org/products/universal-power-supply/).

---

# Software

ANAVI I2C TPM 2.0 is compatible with the `tpm-slb9673.dtbo` device tree binary overlay, which is [included in the official Raspberry Pi Linux kernel](https://github.com/raspberrypi/linux/blob/rpi-6.12.y/arch/arm/boot/dts/overlays/tpm-slb9673-overlay.dts), enabling seamless integration.
...
### Enable I2C and TPM Kernel Support
...
* After reboot ANAVI I2C TPM 2.0 unlocks the partition automatically and `/data` is mounted without a password prompt
...
ANAVI I2C TPM 2.0 is a compact two-layer PCB. Its Bill of Materials (BoM) contains just 8 components: one SLB 9673 chip, four capacitors, and three resistors. On the Raspberry Pi, the ANAVI I2C TPM 2.0 makes use of the following pins:
...
#### Which device tree binary overlay should be used with ANAVI I2C TPM 2.0?

Although ANAVI I2C TPM 2.0 features Infineon Optical™ SLB 9673, the I2C communication is compatible with the  `tpm-slb9673.dtbo` device tree binary overlay, which is [included in the official Raspberry Pi Linux kernel](https://github.com/raspberrypi/linux/blob/rpi-6.12.y/arch/arm/boot/dts/overlays/tpm-slb9673-overlay.dts).

#### Can I disable the RST pin?

Yes. To disable the RST pin, remove resistor R3 from the ANAVI I2C TPM 2.0 printed circuit board using a soldering iron. Once R3 is removed, the RST pin is disconnected.
...
| Date              | Changes                     | Author         |
| ----------------- |:---------------------------:|:---------------|
| 05 July 2026      | Initial manual release      | Leon Anavi     |

## ANAVI I2C TPM 2.0 Revisions
